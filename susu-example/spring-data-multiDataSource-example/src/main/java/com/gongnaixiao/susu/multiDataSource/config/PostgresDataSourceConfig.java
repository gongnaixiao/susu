...
@Configuration
@EnableJdbcRepositories(basePackages = "com.gongnaixiao.susu.multiDataSource.repository.postgres",
        repositoryFactoryBeanClass = PostgresDataSourceConfig.PostgresRepositoryFactoryBean.class
)
public class PostgresDataSourceConfig {
    ...
    @Bean
    BeforeConvertCallback<Blog> beforeSaveCallback() {
    ...
    static class PostgresRepositoryFactoryBean<T extends Repository<S, ID>, S, ID extends Serializable>
        ...
        public PostgresRepositoryFactoryBean(Class<? extends T> repositoryInterface) {
        ...
        public void afterPropertiesSet() {
            ...
            //this.setTransactionManager("postgresTransactionManager");

            super.afterPropertiesSet();
        }

        @Autowired
        private void setOperations(@Qualifier("postgresDataSource") DataSource dataSource) {
