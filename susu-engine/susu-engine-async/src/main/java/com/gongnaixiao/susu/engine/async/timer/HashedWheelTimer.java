...
import com.gongnaixiao.susu.engine.async.timer.utils.ClassUtils;
...
public class HashedWheelTimer implements Timer {
	...
	private static final class HashedWheelTimeout implements Timeout {
		...
		public boolean cancel() {
			...
			// is good enough. This way we
			// can make again use of our LinkedBlockingQueue and so minimize the locking /
	...
	private static final boolean IS_OS_WINDOWS = System.getProperty(OS_NAME_KEY, "")
		.toLowerCase(Locale.US)
		.contains(OS_WIN_PREFIX);
