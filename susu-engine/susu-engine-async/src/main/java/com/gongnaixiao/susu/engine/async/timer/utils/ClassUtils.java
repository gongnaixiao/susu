...
import static com.gongnaixiao.susu.engine.async.timer.utils.Streams.filterAll;
...
public class ClassUtils {
	 ...
	 * @since 2.7.6
	 */
	public static final Set<Class<?>> SIMPLE_TYPES = ofSet(Void.class, Boolean.class, Character.class, Byte.class,
			Short.class, Integer.class, Long.class, Float.class, Double.class, String.class, BigDecimal.class,
			BigInteger.class, Date.class, Object.class);
	...
	/**
	 * Map with primitive type as key and corresponding primitive wrapper type as value,
	 ...
	 * where you absolutely need a non-null ClassLoader reference: for example, for class
	 * path resource loading (but not necessarily for <code>Class.forName</code>, which
	 * accepts a <code>null</code> ClassLoader reference as well).
	...
	/**
	 * Replacement for <code>Class.forName()</code> that also returns Class instances for
	 ...
	 * @return the primitive class, or <code>null</code> if the name does not denote a
	 ...
	 * @return
	 * @deprecated as 2.7.6, use {@link Class#isPrimitive()} plus
	 * {@link #isSimpleType(Class)} instead
	 */
	 ...
	 * @param type the type to test
	 * @return if <code>type</code> is one element of {@link #SIMPLE_TYPES}, return
	 ...
	 * @return if the target type is not null or <code>void</code> or Void.class, return
	 * <code>true</code>, or false
	 * @since 2.7.6
	 */
